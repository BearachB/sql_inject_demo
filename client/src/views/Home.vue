<template>
  <div id="home">
    <div class="w-3/4 mx-auto mt-24 rounded-lg p-8" id='inventory'>
      <p class="text-center text-2xl">Bearach Byrne - Secure Systems</p>
      <p class="text-center text-2xl">Assignment 2: SQLi</p>
      <p class="text-center text-2xl">Product Inventory</p>
